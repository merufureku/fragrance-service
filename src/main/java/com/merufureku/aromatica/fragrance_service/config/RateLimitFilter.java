...
import com.merufureku.aromatica.fragrance_service.utilities.TokenUtility;
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    static {
        ...
        // Fragrance endpoints
        tempMap.put("/fragrances/{id}/notes/{noteId}", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));
        tempMap.put("/public/fragrances/{id}/notes", new RateLimitConfig(60, Duration.ofMinutes(1), RateLimitScope.IP));
        tempMap.put("/fragrances/{id}/notes", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));
        tempMap.put("/public/fragrances/{id}", new RateLimitConfig(60, Duration.ofMinutes(1), RateLimitScope.IP));
        tempMap.put("/fragrances/{id}", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));
        tempMap.put("/public/fragrances", new RateLimitConfig(60, Duration.ofMinutes(1), RateLimitScope.IP));
        tempMap.put("/fragrances", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));

        // Note endpoints
        tempMap.put("/notes/{id}", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));
        tempMap.put("/public/notes", new RateLimitConfig(60, Duration.ofMinutes(1), RateLimitScope.IP));
        tempMap.put("/notes", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));
